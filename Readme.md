...
If you are using the node inspector for [debugging](https://nodejs.org/de/docs/guides/debugging-getting-started/) git-style executable (sub)commands using `node -inspect` et al,
