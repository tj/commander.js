...
/**
 * Represents a command argument with a name, description, and various options.
 * The default is that the argument is required, and you can explicitly indicate this with <> around the name.
 * Put [] around the name for an optional argument.
 */
class Argument {
  /**
