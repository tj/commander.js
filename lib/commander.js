...
Command.prototype.askForNumber = function(str, fn){
...
Command.prototype.askForDate = function(str, fn){
  this.askSingleLine(str, function(val){
    val = new Date(val);
...
Command.prototype.askSingleLine = function(str, fn){
...
Command.prototype.askMultiLine = function(str, fn){
  var buf = '';
  console.log(str);
  process.stdin.setEncoding('utf8');
...
Command.prototype.ask = function(str, fn){
