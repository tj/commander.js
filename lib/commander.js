...
function Option(flags, description) {
  this.flags = flags;
  this.required = (flags.indexOf('<') === -1) ? false : true;
  this.optional = (flags.indexOf('[') === -1) ? false : true;
  this.bool = (flags.indexOf('-no-') === -1) ? true : false;
  flags = flags.split(/[ ,|]+/);
...
Command.prototype.optionExists = function(argv, option){
...
Command.prototype.parseOptions = function(argv){
  ...
  for (var n = 0; n < this.options.length; ++n) {
    ...
    if(option.required === true && this.optionExists(argv, option) === false) {
