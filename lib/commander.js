...
Command.prototype.usage = function(str){
  ...
  if (0 == arguments.length) return this._usage.join('\n') || usage;
  // calling multiple times will add extra usages
...
Command.prototype.helpInformation = function(){
  var usageIntro = '  Usage: ' + this._name + ' ';
  return [
      ''
    , usageIntro + this.usage().replace(/\n/g, function(){
        return '\n'+ pad('', usageIntro.length);
      })
    , '' + this.commandHelp()
    , '  Options:'
    , ''
