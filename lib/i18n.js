...
class I18n {
  ...
  _autoLoadLocale() {
    ...
    try {
      ...
      console.log('Found targetLocaleName');
      targetLocale = new Intl.Locale(targetLocaleName);
      if (!targetLocale) return;
      console.log('Found targetLocale');
    } catch (e) {
      return;
    }
    ...
    if (targetLocale.region) {
      try {
        console.log(`Trying ${targetLocale.language + targetLocale.region}`);
    ...
    try {
      console.log(`Trying ${targetLocale.language}`);
