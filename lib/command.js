...
Expecting one of '${allowedValues.join("', '")}'`);
 ...
 - ${executableDirMessage}`;
   ...
   * as well as a boolean indicating whether a help flag had been found before encountering a subcommand (or before encountering either a subcommand or a command-argument when the default option is being invoked implicitly).
   *
  ...
  parseOptions(argv) {
    ...
    while (args.length) {
      ...
      if (maybeOption(arg)) {
        ...
        if (allArgsConsumedAsOptionsSoFar) {
          reprocessedBySubcommand = true; // reset to false later if no subcommand found
