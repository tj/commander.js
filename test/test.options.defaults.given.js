...
program._data.should.have.property('anchovies', true);
program._data.should.have.property('onions', true);
program._data.should.have.property('olives', 'black');
program._data.should.have.property('sauce', false);
program._data.should.have.property('crust', 'thin');
program._data.should.have.property('cheese', 'wensleydale');
