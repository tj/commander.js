// Partial translation using strings from https://github.com/yargs/yargs/blob/main/locales/it.json
...
const translations = {
  ...
  'output the version number': 'mostra il numero di versione',
  // help option and help command description
  'display help for command': 'mostra la schermata di aiuto',
