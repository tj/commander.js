// Partial translation using strings from https://github.com/yargs/yargs/blob/main/locales/ko.json
// Starting point for full translation, PR welcome!

const translations = {
  // errors
  // commander.missingArgument
  "error: missing required argument '{0}'": "오류: 필수 인수가 주어지지 않았습니다 '{0}'",
  ...
  'error: too many arguments': '오류: 인수가 너무 많습니다',
  ...
  'output the version number': '버전 표시',
  // help option and help command description
  'display help for command': '도움말 표시',
