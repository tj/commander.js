// Partial translation using strings from https://github.com/yargs/yargs/blob/main/locales/jp.json
...
const translations = {
  ...
  'output the version number': 'バージョンを表示',
  // help option and help command description
  'display help for command': 'ヘルプを表示',
