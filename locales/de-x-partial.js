// Partial translation using strings from https://github.com/yargs/yargs/blob/main/locales/de.json
// Starting point for full translation, PR welcome!

const translations = {
  // errors
  // commander.missingArgument
  "error: missing required argument '{0}'": "Fehler: Fehlendes Argument '{0}'",
  ...
  'error: too many arguments': 'Fehler: zu viele Argumente',
  ...
  'output the version number': 'Version anzeigen',
  // help option and help command description
  'display help for command': 'Hilfe anzeigen',
