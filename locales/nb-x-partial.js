// Partial translation using strings from https://github.com/yargs/yargs/blob/main/locales/nb.json
// Starting point for full translation, PR welcome!

const translations = {
  // errors
  // commander.missingArgument
  "error: missing required argument '{0}'": "feil: mangler obligatorisk argument '{0}'",
  ...
  'error: too many arguments': 'feil: for mange argumenter',
  ...
  'output the version number': 'vis versjonsnummer',
  // help option and help command description
  'display help for command': 'vis hjelp',
