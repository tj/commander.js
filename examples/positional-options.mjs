...
// Try the following:
//    node positional-options.mjs upload test.js
//    node positional-options.mjs -p upload test.js
//    node positional-options.mjs upload -p 8080 test.js
//    node positional-options.mjs -p upload -p 8080 test.js
