...
test('when alias subcommand file has no suffix then lookup succeeds', () => {
  return new Promise((resolve) => {
...
test('when subcommand target executablefile has no suffix then lookup succeeds', () => {
  return new Promise((resolve) => {
...
test('when alias subcommand file suffix .js then lookup succeeds', () => {
  return new Promise((resolve) => {
...
test('when subcommand target executablefile has suffix .js then lookup succeeds', () => {
  return new Promise((resolve) => {
...
testOrSkipOnWindows('when subcommand file is symlink then lookup succeeds', (resolve) => {
...
testOrSkipOnWindows('when subcommand file is double symlink then lookup succeeds', (resolve) => {
...
test('when subcommand suffix is .ts then lookup succeeds', () => {
  return new Promise((resolve) => {
...
test('when subsubcommand then lookup sub-sub-command', () => {
  return new Promise((resolve) => {
